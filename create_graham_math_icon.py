#!/usr/bin/env python3
"""Create a simple app icon for Graham's multiplication game."""
...
surface.blit(font_small.render("Graham", True, (245, 248, 255, 255)), font_small.render("Graham", True, (245, 248, 255, 255)).get_rect(center=(SIZE // 2, 188)))
